...
@pytest.fixture
async def waiting_question_singleplayer_state(
    store, preparing_state, run_game_update, participate_update
):
...
@pytest.fixture
async def waiting_answer_singleplayer_state(
    store, waiting_question_singleplayer_state, question_update
):
...
@pytest.fixture
async def after_wrong_answer_singleplayer_state(
    store, waiting_answer_singleplayer_state, wrong_answer_update
):
...
@pytest.fixture
async def after_correct_answer_singleplayer_state(
    store, waiting_answer_singleplayer_state, correct_answer_update
):
...
@pytest.fixture
async def waiting_question_state(
    store, preparing_state, run_game_update, participate_update
):
...
@pytest.fixture
async def after_wrong_answer_state(
    chat_1,
    store,
    run_game_update,
    question_update,
