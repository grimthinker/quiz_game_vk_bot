...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["theme_id"], ["themes.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("title"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["current_question"], ["questions.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["session_state_id"], ["session_states.session_id"], ondelete="CASCADE"
        ),
